...
- [x] **Relay tidak conflict:** IN1 terhubung ke GPIO 4, IN2 terhubung ke GPIO 18, IN3 terhubung ke GPIO 10 (Booked: Greenhouse Blower Fans Contactor Trigger, standby safe OFF). IN4 berstatus TBD / spare.
...
- [x] **Firmware mapping sama dengan documentation:** 26 dari 26 pin cocok 100% dengan `pin_config.h` (termasuk `PIN_OUT_BLOWER_FAN` pada GPIO 10 diselesaikan di SP-HW-011).
...
- [x] **Semua TBD diberi label:** Parameter yang belum memiliki peruntukan fisik (kanal relay IN4, Button 3/4) diberi label TBD / Spare; kanal relay IN3 berstatus Booked/Standby.
