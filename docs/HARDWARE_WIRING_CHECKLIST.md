...
- [x] **Firmware mapping sama dengan documentation:** 25 dari 25 pin cocok 100% dengan `pin_config.h` (migrasi DS3231 I2C dan eliminasi GPIO 47 diselesaikan di SP-HW-006).
