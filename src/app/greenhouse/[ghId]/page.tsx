...
export function CropCycleTimeline({
  ...
  const getVisuals = (id: string, isEnd?: boolean) => {
    ...
    return { color: "text-white", border: "border-white", bg: "bg-[#0b2027]", icon: Sprout, desc: "" };
  };
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      {cycle.status === "NO_CYCLE" && (
        <div className="flex flex-col items-center justify-center rounded-2xl border border-white/10 bg-[#0b2027]/5 p-6 text-center backdrop-blur-sm">
          <div className="relative mb-3 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#0b2027]/10 text-emerald-300 ring-1 ring-white/15">
            <Sprout className="h-7 w-7" />
            <span className="absolute -bottom-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-[#0b2027] ring-1 ring-emerald-200">
              <Plus className="h-3 w-3 text-emerald-200" />
            </span>
          </div>
          ...
          <div className="mt-4 flex flex-col items-center gap-2">
            <Button
              ...
              className="cursor-pointer bg-emerald-400/100 px-5 text-white hover:bg-emerald-600 active:scale-[0.98]"
            >
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#0b2027]/10 text-emerald-300 ring-1 ring-white/15">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="rounded-full bg-[#0b2027] px-2.5 py-0.5 text-[11px] font-extrabold text-emerald-800 shadow-sm">
                    Siklus Aktif
                  </span>
                </div>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex cursor-pointer items-center gap-1.5 rounded-xl border border-white/20 bg-[#0b2027]/10 px-3.5 py-2 text-xs font-semibold text-white backdrop-blur transition hover:bg-[#0b2027]/20 active:scale-[0.98]"
              >
              ...
              <button
                ...
                className="flex cursor-pointer items-center gap-1.5 rounded-xl border border-amber-400/40 bg-amber-400/100/20 px-3.5 py-2 text-xs font-bold text-amber-300 backdrop-blur transition hover:bg-amber-400/100/30 active:scale-[0.98]"
              >
          ...
          <div className="mt-3 grid grid-cols-3 gap-2.5">
            ...
            <div className="relative overflow-hidden rounded-xl border border-emerald-500/25 bg-emerald-900/40 p-3.5 backdrop-blur-sm">
              <div className="flex items-center justify-between">
                ...
                <span className="rounded-full bg-emerald-400/100/25 px-2 py-0.5 text-[10px] font-bold text-emerald-300">
                  HST {hst} hari
                </span>
              </div>
            ...
            {cycle.tanggalPolinasi ? (
              <div className="relative overflow-hidden rounded-xl border border-violet-500/25 bg-violet-900/40 p-3.5 backdrop-blur-sm">
                <div className="flex items-center justify-between">
                  ...
                  <span className="rounded-full bg-violet-400/100/25 px-2 py-0.5 text-[10px] font-bold text-violet-300">
                    HSP {hsp} hari
                  </span>
                </div>
                <div className="mt-2 text-base font-bold text-white">
              ...
              <div className="relative flex flex-col justify-between overflow-hidden rounded-xl border border-dashed border-violet-500/25 bg-violet-900/20 p-3.5 backdrop-blur-sm">
                ...
                <button
                  ...
                  className="mt-2 flex w-full cursor-pointer items-center justify-center gap-1 rounded-lg border border-violet-400/30 bg-[#0b2027]/5 py-1 text-[11px] font-bold text-violet-300 transition hover:bg-violet-400/100/15 active:scale-[0.98]"
                >
          ...
          <div className="bg-[#0a251a] border border-emerald-900/50 p-6 shadow-xl pb-0">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <div className="group relative z-[100]">
                  <button
                    type="button"
                    className="flex items-center justify-center w-5 h-5 rounded-full bg-emerald-400/100/20 text-emerald-400 hover:bg-emerald-400/100/30 transition-colors cursor-pointer"
                  >
            ...
            <div className="relative w-full max-w-full min-w-0 rounded-xl border border-white/5 bg-[#06171f]/50">
              <div className="overflow-x-auto custom-scrollbar">
                ...
                <div className="relative min-w-[1100px] px-[80px]" style={{ height: `${timelineHeight}px` }}>
                  ...
                  <div className="absolute top-[160px] left-[80px] right-[80px] h-[3px] bg-[#0b2027]/20 border-t-2 border-dashed border-white/30" />
      ...
      {cycle.status === "HARVESTED" && (
        <div className="rounded-2xl border border-white/10 bg-[#0b2027]/5 p-5 backdrop-blur-sm">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-white/10 pb-3">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-400/100/20 text-amber-300 ring-1 ring-amber-400/25">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex items-center gap-1.5 rounded-xl border border-white/20 bg-[#0b2027]/10 px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-[#0b2027]/20"
              >
              ...
              <Button
                ...
                size="sm"
                onClick={() => setStartNormalOpen(true)}
                className="bg-emerald-400/100 text-white hover:bg-emerald-600 active:scale-[0.98]"
              >
...
function GreenhouseContent() {
  ...
  return (
    <AppShell complexId={complex.id}>
      <div className="gh-dark-scope min-w-0 w-full max-w-full overflow-x-hidden">
      <style>{`
        .gh-dark-scope {
          --gh-bg: #06141b;
          --gh-panel: #0a1c23;
          --gh-panel-2: #0b222c;
          --gh-line: rgba(255,255,255,.08);
          --gh-muted: #7f969c;
          --gh-text: #f4f8f7;
          --gh-text-2: #c7d5d5;
          color: var(--gh-text);
        ...
        .gh-dark-scope [class~="bg-white"] {
          background-color: var(--gh-panel) !important;
        }
        .gh-dark-scope [class~="bg-slate-50"] {
          background-color: rgba(255,255,255,.025) !important;
        }
        .gh-dark-scope [class~="bg-slate-100"] {
          background-color: var(--gh-panel-2) !important;
        }
        .gh-dark-scope [class~="border-slate-50"],
        .gh-dark-scope [class~="border-slate-100"],
        .gh-dark-scope [class~="border-slate-200"] {
          border-color: var(--gh-line) !important;
        }
        .gh-dark-scope [class~="divide-slate-200"] > :not([hidden]) ~ :not([hidden]) {
          border-color: var(--gh-line) !important;
        }
        .gh-dark-scope [class~="text-slate-900"] { color: #f7fbfa !important; }
        .gh-dark-scope [class~="text-slate-800"] { color: #e6eeee !important; }
        .gh-dark-scope [class~="text-slate-700"] { color: #d3dfdf !important; }
        .gh-dark-scope [class~="text-slate-600"] { color: #bdcdce !important; }
        .gh-dark-scope [class~="text-slate-500"] { color: #8fa4a8 !important; }
        .gh-dark-scope [class~="text-slate-400"] { color: #748c91 !important; }

        .gh-dark-scope input,
        .gh-dark-scope select,
        .gh-dark-scope textarea {
          color: #eef7f5 !important;
          background-color: #0b2027 !important;
          border-color: rgba(255,255,255,.10) !important;
        }
        .gh-dark-scope input::placeholder,
        .gh-dark-scope textarea::placeholder {
          color: #60777c !important;
        }
        .gh-dark-scope input:focus,
        .gh-dark-scope select:focus,
        .gh-dark-scope textarea:focus {
          border-color: rgba(52,211,153,.45) !important;
          box-shadow: 0 0 0 3px rgba(52,211,153,.08) !important;
        }

        .gh-dark-scope [class*="bg-white/"] {
          background-color: rgba(11,32,39,.88) !important;
        }
        .gh-dark-scope [class*="bg-slate-50/"],
        .gh-dark-scope [class*="bg-slate-100/"] {
          background-color: rgba(255,255,255,.025) !important;
        }
        .gh-dark-scope [class*="border-slate-"] {
      ...
      <div className="w-full max-w-full -mt-1.5 overflow-hidden">
      {/* ---------------- Hero ---------------- */}
        ...
        <div className="relative z-10 flex min-h-[340px] flex-col justify-between gap-5 p-6 lg:flex-row lg:items-center lg:gap-8">
          <div className="min-w-0 max-w-[46%] text-white">
            <div className="flex items-center gap-2.5">
              <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#0b2027]/15 backdrop-blur">
              ...
              <div>
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  {gh.cropCycle?.status === "ACTIVE" && (
                    <span className="rounded-full bg-emerald-400/100 px-2.5 py-0.5 text-[11px] font-extrabold text-white shadow-md shadow-emerald-900/40">
                      Active
                    </span>
                  )}
                </div>
            ...
            <div className="flex flex-wrap items-center justify-end gap-2.5">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex h-10 w-9 cursor-pointer items-center justify-center rounded-lg border border-white/25 bg-[#0b2027]/10 text-white backdrop-blur transition hover:bg-[#0b2027]/20"
                >
                  <ChevronLeft className="h-4 w-4" />
                </button>
                <span className="rounded-lg bg-[#0b2027]/15 px-3.5 py-2 text-sm font-bold text-white backdrop-blur">
              ...
              {RANGE_OPTIONS.map((r) => (
                <button
                  ...
                  className={`cursor-pointer rounded-lg px-3.5 py-2 text-[11px] font-semibold transition ${
                    range === r.id
                      ? "bg-emerald-400/100 text-white shadow-[0_4px_16px_rgba(16,185,129,.32)]"
                      : "text-slate-300 hover:bg-[#0b2027]/5 hover:text-white"
                  }`}
                >
                  {r.label}
                </button>
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-5">
            {metrics.map((item) => {
              ...
              const iconClass =
                item.id === "temperature"
                  ? "bg-red-400/100/20 text-red-300 ring-1 ring-red-400/15"
                  : item.id === "humidity"
                    ? "bg-blue-400/100/20 text-blue-300 ring-1 ring-blue-400/15"
                    : item.id === "light"
                      ? "bg-amber-400/100/20 text-amber-300 ring-1 ring-amber-400/15"
                      : item.id === "tank"
                        ? "bg-violet-400/100/20 text-violet-300 ring-1 ring-violet-400/15"
                        : "bg-emerald-400/100/20 text-emerald-300 ring-1 ring-emerald-400/15";
                        ...
                        <div className="mt-1 flex items-baseline gap-1.5">
                          {isFertigation ? (
                            ...
                            <>
                              ...
                              <span className="text-[11px] font-medium text-slate-500">{displayUnit}</span>
                            </>
                          )}
                        </div>
                        {item.id === "tank" && <div className="mt-0.5 text-[10px] text-slate-500">Today</div>}
                        {deltaValue !== null && (
                          <div className={`mt-2 flex items-center gap-1 text-[10px] font-semibold ${deltaValue >= 0 ? "text-emerald-400" : "text-blue-300"}`}>
                            ...
                            {deltaValue > 0 ? "+" : ""}{deltaValue} {item.id === "temperature" ? "°C" : "%"} <span className="font-normal text-slate-500">vs avg</span>
                          </div>
                        )}
                      </div>
                    </div>
          ...
          <div className="mt-5 rounded-2xl border border-white/10 bg-[#081b24] p-4 sm:p-5">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div className="flex min-w-0 items-center gap-3">
                <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-emerald-400/100/15 text-emerald-400 ring-1 ring-emerald-400/10">
                  <Activity className="h-5 w-5" />
                </span>
                <div className="min-w-0">
                  <h3 className="text-[17px] font-bold tracking-tight text-white">Environmental 24H</h3>
                  <p className="mt-0.5 truncate text-[11px] text-slate-500">Temperature, Humidity, Light, Tank Level and Fertigation • {gh.code}</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <select
                ...
                <div className="flex overflow-hidden rounded-lg border border-white/10 bg-black/10 p-0.5">
                  <button type="button" className="rounded-md bg-emerald-400/100 px-3 py-1.5 text-[10px] font-semibold text-white">● Live</button>
              ...
              <div className="relative overflow-hidden rounded-xl border border-white/10 bg-[#071a22] p-5">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-2 flex items-center gap-2 text-[11px] font-semibold text-emerald-400">
                    <span className="grid h-5 w-5 place-items-center rounded-full bg-emerald-400/100/15">✓</span>
                    Feels stable
                  </div>
                    ...
                    <>
                      <div className="mt-7 h-2 rounded-full bg-slate-700/80">
                        <div className="relative h-full rounded-full bg-emerald-400" style={{ width: `${activePosition}%` }}>
                          <span className="absolute right-0 top-1/2 h-4 w-4 -translate-y-1/2 rounded-full border-2 border-white bg-emerald-400/100 shadow-[0_0_16px_rgba(52,211,153,.55)]" />
                        </div>
                      </div>
          ...
          <div className="mt-3 rounded-2xl border border-white/10 bg-[#081b24] p-4 sm:p-5">
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-3">
                <span className="grid h-10 w-10 place-items-center rounded-xl bg-emerald-400/100/15 text-emerald-400 ring-1 ring-emerald-400/10">
                  <Activity className="h-5 w-5" />
                </span>
                <div>
                  <h3 className="text-[17px] font-bold tracking-tight text-white">Environmental 24H Overview</h3>
                  <p className="mt-0.5 text-[11px] text-slate-500">Min, average, max and current values for each parameter</p>
                </div>
              </div>
            ...
            <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-5">
              {metrics.map((item) => {
                ...
                const barClass = item.id === "temperature" ? "bg-red-400/100" : item.id === "humidity" ? "bg-blue-400/100" : item.id === "light" ? "bg-amber-400" : item.id === "tank" ? "bg-violet-400/100" : "bg-emerald-400";
                return (
                  <button
      ...
      {/* Plant & Fruit Data */}
      <div className="mt-5">
        <SectionCard className="gh-surface !border-0 !shadow-none bg-[#0b2027]"
        ...
        >
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-xl border border-[--color-line] bg-[#0b2027]/70 p-4">
              <div className="flex items-center gap-2 text-xs font-medium text-slate-500">
                <Sprout className="h-4 w-4 text-emerald-500" /> Plants
              </div>
              <div className="mt-2 flex items-end gap-2">
                <span className="text-3xl font-bold text-white">{n(gh.plants.total)}</span>
            ...
            <div className="rounded-xl border border-[--color-line] bg-[#0b2027]/70 p-4">
              ...
              <div className="mt-2 flex items-end gap-2">
                <span className="text-3xl font-bold text-white">{n(gh.plants.totalFruits)}</span>
                <span className="pb-1 text-xs text-slate-500">recorded</span>
              </div>
              <div className="mt-2 text-[11px] text-slate-500">
                Avg weight: <span className="font-semibold text-slate-200">{n(gh.plants.avgFruitWeightG)} g</span>
              </div>
            </div>
          </div>
          <div className="mt-3 rounded-lg bg-blue-400/10/70 px-3 py-2 text-[11px] leading-relaxed text-blue-200">
      ...
      <div className="mb-5 grid grid-cols-2 gap-4 md:grid-cols-3 xl:grid-cols-6">
        <div className="group rounded-none border-0 border-l-2 border-red-400 bg-[#0b2027]/85 p-4 shadow-none transition hover:bg-red-400/[0.06]">
          <div className="flex items-center justify-between">
            <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-red-400/10 text-red-500">
          ...
          <div className="text-2xl font-bold text-white">
            {gh.telemetry.temperatureC !== null ? gh.telemetry.temperatureC.toFixed(1) : "–"}<span className="text-sm font-medium text-slate-500"> °C</span>
          </div>
        </div>
        <div className="group rounded-none border-0 border-l-2 border-sky-400 bg-[#0b2027]/85 p-4 shadow-none transition hover:bg-sky-400/[0.06]">
          <div className="flex items-center justify-between">
            <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-sky-400/10 text-sky-500">
          ...
          <div className="text-2xl font-bold text-white">
            {gh.telemetry.humidityPct ?? "–"}<span className="text-sm font-medium text-slate-500"> %</span>
          </div>
        </div>
        <div className="group rounded-none border-0 border-l-2 border-amber-400 bg-[#0b2027]/85 p-4 shadow-none transition hover:bg-amber-400/[0.06]">
          ...
          <div className="text-2xl font-bold text-white">
            {gh.telemetry.lightLux !== null ? (gh.telemetry.lightLux / 1000).toFixed(1) : "–"}<span className="text-sm font-medium text-slate-500"> klux</span>
          </div>
          <div className="mt-0.5 text-[11px] text-slate-500">{lux(gh.telemetry.lightLux)}</div>
        </div>
        <div className="group rounded-none border-0 border-l-2 border-emerald-500 bg-[#0b2027]/85 p-4 shadow-none transition hover:bg-emerald-400/[0.06]">
          <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-emerald-400/10 text-emerald-600">
            <Sprout className="h-[18px] w-[18px]" />
          </span>
          <div className="mt-2.5 text-xs text-slate-500">HST <span className="text-slate-500">(Hari Setelah Tanam)</span></div>
          <div className="text-2xl font-bold text-white">
            {gh.cropCycle?.status === "ACTIVE" ? (
              <>
                {gh.telemetry.hstDays}<span className="text-sm font-medium text-slate-500"> days</span>
              </>
            ) : gh.cropCycle?.status === "HARVESTED" ? (
        ...
        <div className="group rounded-none border-0 border-l-2 border-violet-400 bg-[#0b2027]/85 p-4 shadow-none transition hover:bg-violet-400/[0.06]">
          <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-violet-400/10 text-violet-500">
            <Apple className="h-[18px] w-[18px]" />
          </span>
          <div className="mt-2.5 text-xs text-slate-500">HSP <span className="text-slate-500">(Hari Setelah Polinasi)</span></div>
          <div className="text-2xl font-bold text-white">
            {gh.cropCycle?.status === "ACTIVE" && gh.telemetry.hspDays !== null ? (
              <>
                {gh.telemetry.hspDays}<span className="text-sm font-medium text-slate-500"> days</span>
              </>
            ) : (
              <span className="text-slate-500">–</span>
            )}
        ...
        <div className="group rounded-none border-0 border-l-2 border-blue-400 bg-[#0b2027]/85 p-4 shadow-none transition hover:bg-blue-400/[0.06]">
          <div className="flex items-center justify-between">
            <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-400/10 text-blue-500">
          ...
          <div className="text-2xl font-bold text-white">
            {gh.telemetry.waterTodayL !== null ? n(gh.telemetry.waterTodayL) : "–"}<span className="text-sm font-medium text-slate-500"> L</span>
          </div>
      ...
      <SectionCard
        ...
        className="mb-5 gh-surface !border-0 !shadow-none bg-[#0b2027] ring-1 ring-slate-200/70"
        action={
          <div className="flex items-center gap-2 text-[11px]">
            <span className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 font-semibold ${gh.online ? "bg-emerald-400/10 text-emerald-600" : "bg-red-400/10 text-red-600"}`}>
              <span className={`h-1.5 w-1.5 rounded-full ${gh.online ? "bg-emerald-400/100" : "bg-red-400/100"}`} />
      ...
      >
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-[minmax(0,2fr)_minmax(260px,1fr)]">
          {/* Main camera */}
          <div className="group relative min-h-[250px] overflow-hidden rounded-xl border border-white/10 bg-[#0b2027] lg:min-h-[330px]">
            ...
            <span className="absolute right-3 top-3 inline-flex items-center gap-1.5 rounded-full bg-emerald-400/100/90 px-2.5 py-1.5 text-[10px] font-semibold text-white">
              <span className="h-1.5 w-1.5 rounded-full bg-[#0b2027]" /> LIVE
            </span>
          ...
          <div className="grid min-h-[250px] grid-rows-2 gap-3 lg:min-h-[330px]">
            {[2, 3].map((camera) => (
              <div key={camera} className="group relative min-h-0 overflow-hidden rounded-xl border border-white/10 bg-[#0b2027]">
                <GreenhouseArt crop={gh.crop} variant="landscape" className="h-full w-full transition duration-500 group-hover:scale-[1.01]" />
        ...
        <div className="mt-3 grid grid-cols-2 divide-x divide-white/8 overflow-hidden rounded-xl border border-white/8 bg-[#0b2027]/80 sm:grid-cols-3 lg:grid-cols-6">
          {[
            ...
            <div key={item.label} className="min-w-0 px-3 py-2.5">
              <div className="truncate text-[10px] text-slate-500" title={item.hint}>{item.label}</div>
              <div className="mt-0.5 truncate text-sm font-bold text-slate-100">{item.value}</div>
            </div>
          ))}
        </div>
      </SectionCard>
      ...
      <div className="mb-5 grid grid-cols-1 gap-4 xl:grid-cols-3">
        ...
        {gh.currentRun ? (
          <SectionCard
            ...
            className="xl:col-span-2 gh-surface !border-0 !shadow-none bg-[#0b2027]"
            action={<StatusBadge status="running" />}
          >
            <div className="mb-3.5 flex items-center justify-between text-[13px]">
              <span className="font-semibold text-slate-100">{gh.currentRun.recipeName}</span>
            ...
            <div className="mt-3.5 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {[
                ...
                <div key={s.label} className="rounded-lg border border-white/8 bg-[#0b2027]/70 px-3 py-2.5">
                  <div className="text-[11px] text-slate-500">{s.label}</div>
                  <div className="mt-0.5 text-sm font-bold text-slate-100">{s.value}</div>
                </div>
              ))}
            </div>
          </SectionCard>
        ) : (
          <SectionCard title="Mixing Tank" icon={Beaker} iconTone="blue" className="xl:col-span-2 gh-surface !border-0 !shadow-none bg-[#0b2027]" realtime={ghRealtimeState}>
            <div className="flex items-center gap-5">
              <div className="relative h-24 w-16 overflow-hidden rounded-lg border border-white/10 bg-[#0b2027]">
        ...
        >
          {nextSchedule ? (
            <div className="space-y-3">
              <div className="flex items-center gap-3 rounded-xl border border-violet-300/10 bg-violet-400/10/50 p-3.5">
                <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-violet-100 text-violet-600">
                  <Clock className="h-5 w-5" />
                </span>
                <div>
                  <div className="text-lg font-bold text-white">{nextSchedule.time}</div>
                  <div className="text-xs text-slate-500">{nextSchedule.name}</div>
                </div>
                <StatusBadge status="scheduled" className="ml-auto" />
              </div>
              <div className="space-y-2 text-[13px]">
                <div className="flex justify-between"><span className="text-slate-500">Recipe</span><span className="font-medium text-slate-100">{gh.recipes.find((r) => r.id === nextSchedule.recipeId)?.name ?? "–"}</span></div>
                <div className="flex justify-between"><span className="text-slate-500">Target Water</span><span className="font-medium text-slate-100">{nextSchedule.targetWaterL} L</span></div>
                <div className="flex justify-between"><span className="text-slate-500">Repeat</span><span className="font-medium text-slate-100">{nextSchedule.repeat}</span></div>
              </div>
            </div>
          ) : (
            <p className="text-sm text-slate-500">No upcoming schedule for this greenhouse.</p>
          )}
        </SectionCard>
      </div>
        ...
        >
          {gh.fertigationSchedules.length === 0 ? (
            ...
            <table className="w-full text-[13px]">
              <thead>
                <tr className="border-b border-white/8 text-left text-[11px] uppercase tracking-wide text-slate-500">
              ...
              <tbody>
                {gh.fertigationSchedules.map((s) => (
                  <tr key={s.id} className="border-b border-white/5 last:border-0">
                    <td className="py-2.5 font-semibold text-slate-100">{s.time}</td>
                    <td className="py-2.5 text-slate-300">{gh.recipes.find((r) => r.id === s.recipeId)?.name ?? "–"}</td>
                    <td className="py-2.5 text-slate-300">~23 min</td>
              ...
              <tbody>
                {gh.history.map((h) => (
                  <tr key={h.id} className="border-b border-white/5 last:border-0">
                    <td className="py-2.5 font-medium text-slate-100">{h.date} {h.time}</td>
                    <td className="py-2.5 text-slate-300">{h.recipeName}</td>
                    <td className="py-2.5 text-slate-300">{h.waterL} L</td>
                    <td className="py-2.5 text-slate-300">A {h.dosingAml} / B {h.dosingBml} ml</td>
      ...
      <div className="mb-5 grid grid-cols-1 gap-4 xl:grid-cols-2">
        <SectionCard className="gh-surface !border-0 !shadow-none bg-[#0b2027]" title="Plant Overview" icon={Sprout} iconTone="green">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1 space-y-2.5">
              {[
                { label: "Alive", value: gh.plants.alive, color: "bg-emerald-400/100", pct: Math.round((gh.plants.alive / Math.max(1, gh.plants.total)) * 100) },
                { label: "Dead", value: gh.plants.dead, color: "bg-red-400/100", pct: Math.round((gh.plants.dead / Math.max(1, gh.plants.total)) * 100) },
                { label: "Tracked", value: gh.plants.tracked, color: "bg-blue-400/100", pct: Math.round((gh.plants.tracked / Math.max(1, gh.plants.total)) * 100) },
              ].map((r) => (
                <div key={r.label}>
                  <div className="mb-1 flex items-center justify-between text-[13px]">
                    <span className="text-slate-300">{r.label}</span>
                    <span className="font-semibold text-slate-100">{r.value} ({r.pct}%)</span>
                  </div>
                  <div className="h-1.5 w-full overflow-hidden rounded-full bg-[#0b2027]">
                    <div className={`h-full rounded-full ${r.color}`} style={{ width: `${r.pct}%` }} />
                  </div>
                </div>
              ))}
              <div className="pt-1 text-[11px] text-slate-500">Survival rate {Math.round((gh.plants.alive / Math.max(1, gh.plants.total)) * 100)}%</div>
            </div>
          </div>
        </SectionCard>
        ...
        >
          ...
          <div className="mt-2 flex items-center gap-4 text-[11px] text-slate-500">
            <span className="flex items-center gap-1.5"><span className="h-2 w-2 rounded-full bg-emerald-400/100" /> Fruit count</span>
            <span className="flex items-center gap-1.5"><span className="h-2 w-2 rounded-full bg-blue-400/100" /> Avg weight (g)</span>
          </div>
        </SectionCard>
      </div>

      {/* ---------------- Equipment ---------------- */}
      <SectionCard className="gh-surface !border-0 !shadow-none bg-[#0b2027]" title="GH Hardware &amp; Capability" icon={Wrench} iconTone="slate" realtime={ghRealtimeState} subtitle="Dedicated hardware reported by the Complex controller">
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-8">
          {equipmentCards.map((eq) => (
            <div key={eq.name} className={`rounded-xl border p-3 text-center ${eq.status === "OFFLINE" ? "border-white/10 bg-[#0b2027]/[0.035] opacity-70" : "border-[--color-line] bg-[#0b2027]/70"}`}>
              <div className="text-sm font-semibold text-slate-100">{eq.name}</div>
              <div className="mt-1 text-[10px] text-slate-500">{eq.detail}</div>
