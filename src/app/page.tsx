          ...
          {observations.length > 0 && (
            <div className="mt-3 space-y-1.5">
              ...
              {observations.slice(0, 3).map((o) => (
                <div key={o.observationId} className="flex items-center gap-2 rounded-lg border border-slate-100 bg-white px-2.5 py-2 text-xs">
                  ...
                  <span className="ml-auto text-slate-400">{new Date(o.observedAt).toLocaleString("id-ID")}</span>
