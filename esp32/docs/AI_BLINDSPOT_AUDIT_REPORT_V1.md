...
> [!NOTE]
> **HISTORICAL DOCUMENTATION (SUPERSEDED):** Flow meter model assignments in this audit report reflect historical assumptions. The current authoritative specification uses **ZJ-B1** for Raw Water Flow on GPIO 15 (calibration required) and **FS400A G1"** for Fertigation Flow on GPIO 16 (F=4.8*Q, 288 pulses/L). YF-B1 is obsolete.
