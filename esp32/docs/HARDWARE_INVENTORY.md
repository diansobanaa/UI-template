...
| **RELAY** | 4-Channel Relay Board | 4-Channel 5V Optocoupled (VCC-JDVCC jumper installed) | 1 | 5V Coil, 5V Logic | Active-LOW (IN1: GPIO 4, IN2: GPIO 18, IN3: GPIO 10 Booked, IN4: TBD) | **VERIFIED READY** | Intermediate galvanic isolation and load switching. IN3 booked for Dual Blower Contactor Trigger. |
...
| **ETH** | W5500 SPI Ethernet Module | W5500 Hardwired TCP/IP | 1 | 3.3V DC Supply | Shared SPI (CS: GPIO 10 previously) | **NOT USED IN CURRENT COMMISSIONING** | Wired LAN interface. GPIO 10 reassigned to Blower Fan Contactor Trigger. |
