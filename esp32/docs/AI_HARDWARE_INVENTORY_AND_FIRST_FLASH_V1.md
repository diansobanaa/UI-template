...
> [!NOTE]
> **HISTORICAL DOCUMENTATION (SUPERSEDED):** Flow meter specifications in this historical report reflect early assumptions. For authoritative active specifications, refer to [HARDWARE_INVENTORY.md](file:///d:/template/docs/HARDWARE_INVENTORY.md), [COMPONENT_PIN_MAP.md](file:///d:/template/docs/COMPONENT_PIN_MAP.md), and [HARDWARE_WIRING_MAP.md](file:///d:/template/docs/HARDWARE_WIRING_MAP.md): **ZJ-B1** for Raw Water Flow Meter on GPIO 15 (1–25 L/min, calibration required); **FS400A G1"** for Fertigation Flow Meter on GPIO 16 (1–60 L/min, F=4.8*Q, 288 pulses/L). YF-B1 is obsolete.
